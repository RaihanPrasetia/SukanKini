    ...
    <div className="p-6 font-sans text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {classes.map((trainingClass, index) => (
          <div
            key={index}
            className="flex flex-col bg-gray-800 text-white rounded-lg shadow-md overflow-hidden"
          >
            <div className="relative flex-none h-40">
              ...
              />
              <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center text-white text-sm font-bold opacity-0 hover:opacity-100 transition-opacity duration-300">
                {trainingClass.title}
              </div>
            </div>
            <div className="flex-1 p-4 text-left">
              ...
              <div className="mt-3 flex flex-col sm:flex-row">
                <button className="px-4 py-2 bg-white text-gray-800 font-bold rounded-md mr-3 mb-3 sm:mb-0 hover:bg-gray-200">
                  Lihat Kelas
                </button>
