...
<div className="w-full bg-gray-50 p-6 py-24 lg:pt-32 rounded-lg shadow-lg min-h-[80vh]">
    ...
    <div className="overflow-x-auto bg-white shadow-lg sm:rounded-lg">
        <table className="min-w-full text-sm text-left text-gray-500">
            <thead className="text-xs text-gray-700 uppercase bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
                <tr>
                ...
                <tr key={payment.id}
                    ...
                    <td className="px-6 py-4">
                        <span className={`inline-block px-4 py-2 text-sm font-semibold rounded-full ${
                            payment.status==="Diproses" ? "bg-yellow-100 text-yellow-800" : payment.status==="Diterima"
    ...
    <div className="fixed inset-0 z-50 flex justify-center items-center bg-gray-800 bg-opacity-50">
        <div className="bg-white p-6 rounded-lg max-w-sm w-full relative">
            <div className="flex justify-between items-center mb-4">
                ...
                <h3 className={`inline-block px-3 py-1 text-sm font-semibold rounded-full
            ...
            <div className="flex justify-between items-center">
                <button onClick={closeModal} className="px-4 py-2 bg-gray-500 rounded-lg font-semibold text-white">
                    Tutup
                </button>

                {selectedPayment.status === "Diproses" && (
                <div className="flex items-center gap-2 justify-start">
                    <button className="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-700" onClick={()=>
                        handleModalAction("accept")}
                        >
                        Terima
                    </button>
                    <button className="ml-2 bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-700" onClick={()=>
