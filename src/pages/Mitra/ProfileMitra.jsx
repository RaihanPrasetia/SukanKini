...
const ProfileMitra = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row py-10 px-10 space-y-4 md:space-y-0 md:space-x-4 min-h-[80vh]">
      <div className="flex flex-col space-y-6 w-full">
        ...
        {/* Content Area */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white shadow-lg rounded-lg p-6">
