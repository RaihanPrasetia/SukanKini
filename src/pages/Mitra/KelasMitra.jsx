...
<div className="w-full bg-white p-6 lg:px-16 rounded-lg py-24 lg:pt-32 shadow-lg min-h-[80vh]">
    ...
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 backdrop-blur-sm flex justify-center items-center z-50">
        <div className="bg-white p-4 rounded-lg shadow-2xl w-full sm:w-3/4 md:w-2/3 lg:w-1/2">
            ...
            <form onSubmit={handleFormSubmit}>
                ...
                <div>
                    ...
                    {trainers.length === 0 ? (
                    <p className="text-red-500 font-semibold text-sm">Silahkan buat Pelatih Terlebih dahulu</p>
                    ) : (
                ...
                <div className="mt-4 mb-4">
                    ...
                    <div className="flex items-center space-x-2 mb-2">
                        ...
                        <button type="button" onClick={()=> {
                            ...
                            className="py-1 px-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none
                ...
                <div className="flex justify-end space-x-2">
                    <button type="button"
                        className="py-1 px-4 bg-red-500 text-white rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400"
                        onClick={handleModalClose}>
                        Batal
                    </button>
                    <button type="submit"
                        className="py-1 px-4 bg-green-500 text-white rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400">
                        Simpan
                    </button>
                </div>
            </form>
    ...
    <div className="overflow-x-auto mt-6">
        ...
        <div className="text-center">Loading...</div>
            ...
            <table className="min-w-full text-sm text-left text-gray-700 bg-white rounded-lg shadow-lg">
            <thead className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                <tr>
                    <th className="px-6 py-4 border-b font-semibold">Gambar</th>
                    <th className="px-6 py-4 border-b font-semibold">Nama Kelas</th>
                    <th className="px-6 py-4 border-b font-semibold">Kategori</th>
                    <th className="px-6 py-4 border-b font-semibold">Hari & Jam</th>
                    <th className="px-6 py-4 border-b font-semibold">Trainer</th>
                    <th className="px-6 py-4 border-b font-semibold">Alamat</th>
                    <th className="px-6 py-4 border-b font-semibold">Harga</th>
                    <th className="px-6 py-4 border-b font-semibold">Aksi</th>
                </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
                {classes.map((kelas) => (
                    <tr key={kelas.id} className="hover:bg-blue-50 transition-colors">
                        ...
                        <td className="px-6 py-4 font-semibold text-gray-900">{kelas.name}</td>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-800">{kelas.address}</td>
                        ...
                        <td className="px-6 py-4 text-center">
                            <div className="flex justify-center gap-2">
                                <button
                                    ...
                                    className="bg-yellow-500 text-white py-2 px-4 rounded-lg hover:bg-yellow-600 shadow transition"
                                >
                                    Edit
                                </button>
                                <button
                                    onClick={() => handleDelete(kelas.id)}
                                    className="bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-600 shadow transition"
                                >
                                    Hapus
                                </button>
                                <button
                                    onClick={() => handleViewDetails(kelas.id)}
                                    className="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 shadow transition"
                                >
                                    Lihat
                                </button>
                            </div>
