...
<div className="w-full bg-white p-6 lg:px-16 rounded-lg py-24 lg:pt-32 shadow-lg min-h-[80vh]">
    ...
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
        <div className="bg-white p-8 rounded-lg shadow-2xl w-full sm:w-3/4 md:w-2/3 lg:w-1/2">
            <h3 className="text-2xl font-semibold mb-6 text-center text-gray-800">Buat Kelas</h3>
            <form onSubmit={handleFormSubmit}>
                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center space-x-4 mb-4">
                        <select name="hari" value={newSchedule.hari} onChange={(e)=> setNewSchedule({ ...newSchedule,
                            hari: e.target.value })}
                            className="w-1/2 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2
                            focus:ring-blue-500"
                            >
                        ...
                        <button type="button" onClick={()=> {
                            ...
                            className="py-2 px-6 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="file" name="image_path" onChange={(e)=> setFormData({ ...formData, image_path:
                        e.target.files[0] })}
                ...
                <div className="flex justify-end space-x-4">
                    <button type="button"
                        className="py-2 px-6 bg-red-500 text-white rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400"
    ...
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
        <div className="bg-white p-8 rounded-lg shadow-xl w-full sm:w-3/4 md:w-2/3 lg:w-1/2">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">Edit Kelas</h3>
            <form onSubmit={handleEditFormSubmit}>
                {/* Kategori & Pelatih */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                    <div className="w-full">
                        <label className="block text-sm font-medium text-gray-700 mb-2">Nama Kelas</label>
                        <input type="text" name="name" value={formData.name || editingClass.name}
                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <input type="time" name="jam" value={newSchedule.jam} onChange={(e)=> setNewSchedule({
                        ...newSchedule, jam: e.target.value })}
                        className="w-1/2 p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2
                        focus:ring-blue-500"
                        />
                        ...
                        <button type="button" onClick={()=> {
                            ...
                            className="py-3 px-6 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none
                            focus:ring-2 focus:ring-blue-500"
                            >
                            Tambah
                        </button>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                    <div className="w-full">
                        <label className="block text-sm font-medium text-gray-700 mb-2">Alamat</label>
                        <input type="text" name="address" value={formData.address || editingClass.address}
                            onChange={handleInputChange}
                            className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                            required />
                    </div>
                    <div className="w-full">
                        <label className="block text-sm font-medium text-gray-700 mb-2">Harga</label>
                        <input type="number" name="price" value={formData.price || editingClass.price}
                            onChange={handleInputChange}
                            className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                            required />
                    </div>
                    <div className="w-full">
                        ...
                        {formData.image_path && (
                        <div className="mt-4">
                            <img src={URL.createObjectURL(formData.image_path)} alt="Preview"
    ...
    <div className="overflow-x-auto mt-6">
        ...
        <table className="min-w-full text-sm text-left text-gray-500 rounded-lg shadow-lg bg-white">
            <thead className="bg-blue-600 text-white">
                <tr>
                    <th className="px-6 py-4 border-b">Gambar</th>
                    <th className="px-6 py-4 border-b">Nama Kelas</th>
                    <th className="px-6 py-4 border-b">Kategori</th>
                    <th className="px-6 py-4 border-b">Hari & Jam</th>
                    <th className="px-6 py-4 border-b">Trainer</th>
