...
function Home() {
    ...
    const closeModal = () => {
        ...
        setIsForgotPassword(false); // Reset forgot password state when closing modal
    };
    const toggleForm = () => {
        setIsSignUp(!isSignUp);
        setIsForgotPassword(false); // Reset forgot password state when toggling forms
    }; // Toggle between login and signup
    const toggleForgotPassword = () => setIsForgotPassword(!isForgotPassword); // Toggle forgot password
                ...
                <div className="relative z-10 text-left text-white max-w-2xl p-6">
                    ...
                    <div className="flex items-center space-x-4 mb-8">
                        <button onClick={openModal}
                            className="bg-yellow-400 text-black font-semibold py-2 px-6 rounded-full hover:bg-yellow-500 transition duration-300">
                            Gabung Sekarang
                        </button>

                        <button
                            className="flex items-center text-white bg-transparent border-2 border-white py-2 px-6 rounded-full hover:bg-white hover:text-blue-800 transition duration-300">
            ...
            <AnimatePresence>
                {isModalOpen && (
                    <div className="fixed inset-0 flex items-center justify-center z-20">
                        ...
                        <motion.div
                            className="bg-white rounded-lg w-[90%] lg:w-[70%] mx-auto z-10 relative flex overflow-hidden"
