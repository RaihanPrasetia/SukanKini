...
function Komunitas() {
    return (
        <div className="w-full flex flex-col justify-center items-center bg-gradient-to-r from-blue-50 to-green-50 py-10 px-4 md:px-36 rounded-lg shadow-lg mt-20">
            {/* Header Section */}
            <div className="flex flex-col w-full space-y-8">
                ...
                <div className="text-center mt-10">
                    <Link to={'#'} className="text-xl bg-gradient-to-r from-green-500 to-blue-500 py-3 px-6 rounded-full text-white font-semibold shadow-lg hover:from-blue-500 hover:to-green-500 transition duration-300 ease-in-out transform hover:scale-105">
                        Lihat Komunitas
                    </Link>
                </div>
            </div>
