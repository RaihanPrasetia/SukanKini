...
function Pelatih() {
    ...
    useEffect(() => {
        // Store the current value of sectionRef in a variable to avoid issues with async updates
    ...
    const communityCards = [
        {
            id: 1,
            title: 'Yakkhukkhan',
            image: '/assets/images/pelatih/yakhhukhan.jpg',
        },
        {
            id: 2,
            title: 'Amy Jem',
            image: '/assets/images/pelatih/amyjem.jpg',
        },
        {
            id: 3,
            title: 'Rolland Shak',
            image: '/assets/images/pelatih/rolland.jpg',
        },
        {
            id: 4,
            title: 'Natalinne Stuart',
            image: '/assets/images/pelatih/natalinne.jpg',
        },
    ];
        ...
        >
            ...
            >
                {communityCards.map((card, index) => (
                    <motion.div
                        key={card.id}
                        className="relative group transition-transform duration-300 transform hover:scale-105"
                        variants={{
                    ...
                    >
                        <img
                            src={card.image}
                            alt={card.title}
                            className="w-full h-60 md:h-80 object-cover rounded-md transition-transform duration-300 group-hover:scale-105"
                        />
