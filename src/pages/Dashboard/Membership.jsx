...
const Membership = () => {
    ...
    const closeModal = () => {
        ...
        setTimeout(() => setSelectedPlan(null), 300); // Delay unsetting the plan to match the animation
    };

    return (
        <div className="min-h-screen bg-gradient-to-b from-green-600 to-gray-100 p-8">
            ...
            {isModalOpen && selectedPlan && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50 animate-fadeIn">
                    <div className="bg-white rounded-lg shadow-lg flex w-11/12 md:w-3/4 lg:w-2/3 transform transition-all duration-300 ease-out">
                        {/* Left Section: Image and Description */}
                        <div className="w-1/3 p-6 bg-green-100 rounded-l-lg flex flex-col items-center justify-center animate-slideInLeft">
                        ...
                        {/* Right Section: Form */}
                        <div className="w-2/3 p-8 relative animate-slideInRight">
