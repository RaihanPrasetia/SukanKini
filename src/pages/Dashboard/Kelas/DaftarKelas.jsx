...
const DaftarKelasPopup = ({ onClose, classInfo }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50 px-4">
      <div className="bg-white rounded-lg shadow-2xl max-w-lg w-full overflow-hidden transform transition-all duration-300 scale-100">
        {/* Header Image */}
        ...
        <div className="p-6">
          ...
          <div className="space-y-3 text-gray-700">
            ...
            <p>
              <strong className="font-medium">Harga:</strong> Rp {classInfo.price.toLocaleString()}
            </p>
          </div>
        ...
        <div className="px-6 pb-6 flex justify-center">
          <button
            ...
            className="bg-gradient-to-r from-green-400 to-green-600 text-white px-6 py-3 rounded-lg shadow-lg hover:from-green-500 hover:to-green-700 transition-all transform hover:scale-105"
          >
          ...
          <div className="bg-white rounded-lg shadow-lg max-w-sm w-full p-6 animate-slide-up">
            ...
            <div className="flex justify-between mt-6">
              ...
              <button
                ...
                className={`bg-gradient-to-r from-green-400 to-green-600 text-white px-4 py-2 rounded-lg shadow-lg hover:from-green-500 hover:to-green-700 transition-all transform hover:scale-105 ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""}`}
              >
