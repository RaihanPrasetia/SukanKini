...
<div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 px-4">
  <div className="bg-white rounded-lg shadow-2xl max-w-lg w-full overflow-hidden">
    ...
    <div className="relative h-48">
      ...
      <button onClick={onClose}
        className="absolute top-4 right-4 bg-white text-gray-700 p-2 rounded-full shadow-md hover:text-red-600 hover:bg-gray-200 transition-transform transform hover:scale-110">
        ✕
      </button>
    </div>
    ...
    <div className="p-6 space-y-4">
      <h2
        className="text-3xl font-extrabold text-gray-800 mb-2 text-center hover:text-indigo-600 transition-colors duration-300">
        {classInfo.name}
      </h2>
      <h3 className="text-xl font-semibold text-green-600 text-center uppercase tracking-wide">
        {classInfo.owner.name}
      </h3>
      <div className="space-y-2">
        <p className="text-gray-700">
          <strong className="text-gray-900">Pelatih:</strong> {classInfo.trainer.name}
        </p>
        <p className="text-gray-700">
          <strong className="text-gray-900">Alamat:</strong> {classInfo.address}
        </p>
        <p className="text-gray-700">
        ...
        <p className="text-gray-700">
          <strong className="text-gray-900">Harga:</strong> Rp{" "}
  ...
  {/* Payment Modal */}
  {showPaymentModal && (
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 px-4 py-8">
  <div className="bg-white rounded-lg shadow-lg max-w-md w-full p-6">
    ...
    <select
      className="w-full px-4 py-3 border border-gray-300 rounded-lg mb-6 text-gray-700 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
      value={selectedBank}
    ...
    {/* Bank Details */}
    {bankDetails && (
      <div className="p-4 border border-green-200 bg-green-50 rounded-lg shadow-md mb-6">
    ...
    <div className="flex justify-between">
      ...
      <button
        ...
        className={`bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-600 transition-colors ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""}`}
      >
