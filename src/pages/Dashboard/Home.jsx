  ...
  return (
    <>
      ...
      <section className="relative w-full bg-cover bg-center overflow-hidden">
        <div
          className="flex flex-col items-center justify-center w-full h-screen px-8 py-16 md:px-16 md:py-24 bg-cover bg-center relative"
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1621427380075-ae3e4fcc5333?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
          }}
        >
          {/* Dark Overlay */}
      ...
      <section id="komunitas" className="py-16 bg-white">
        <Komunitas />
      </section>
