...
export default function Home() {
    ...
    return (
        <>
            {/* hero section */}
            <section className="w-full h-150vh bg-cover bg-center overflow-hidden relative">
                <div className="flex flex-col items-center justify-center w-full h-screen px-8 py-16 md:px-16 md:py-24 bg-cover bg-center"
                    style={{
                    ...
                    <div className="flex flex-col items-center justify-center space-y-4 pb-10">
                        ...
                        <p className="mt-2 text-sm sm:text-md md:text-lg text-center text-white opacity-80">
                            Banyak yang bisa kamu jelajahi! Temukan kelas-kelas baru, coba aktivitas seru, dan mulai gaya hidup
                            sehat yang lebih menyenangkan!
                        </p>
                    </div>
