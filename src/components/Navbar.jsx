                ...
                <div className={`md:flex md:items-center ${isOpen ? 'block' : 'hidden'} w-full md:w-auto`}>
                    <div className="flex flex-col md:flex-row mt-4 md:mt-0">
                        ...
                        <div className="relative group">
                            ...
                            {isDropdownOpen && (
                                <div className="absolute z-50 left-0 transform transition duration-300 translate-x-2 opacity-100 bg-white text-gray-800 rounded-md shadow-lg mt-2">
                        ...
                        <Link to="#" onClick={(e) => { e.preventDefault(); document.getElementById('pelatih').scrollIntoView({ behavior: 'smooth' }); }} className="text-white hover:text-blue-300 py-2 px-4 md:mr-4 transition duration-300">
                            Pelatih
                        </Link>
                    </div>
                    ...
                    <div className="mt-4 md:mt-0">
                        <Link to="/Dashboard"
                            className="bg-yellow-400 text-black hover:bg-yellow-500 py-2 px-4 rounded-full font-semibold transition duration-300">
                            Gabung Sekarang
                        </Link>
                    </div>
                </div>
